...
evaluates on a validation set, and saves weights to saved_models/stock_transformer.pth.
"""
...
from model_code.lab5_transformer_model import (
    StockTransformer,
...
def train_transformer(
    ...
    out_path = os.path.join("saved_models", "stock_transformer.pth")
    checkpoint = {
        "config": {
