...
from ml.sentiment_preprocessing import TextPreprocessor, Vocabulary
from ml.sentiment_lstm_model import SentimentLSTM, create_model
...
def predict_sentiment_score(
    ...
    if model_path is None:
        if model_type == "lstm":
            model_path = "models/sentiment_lstm.pth"
