...
from ml.sentiment_lstm_model import create_model, count_parameters
from ml.sentiment_preprocessing import (
    TextPreprocessor,
...
def main():
    ...
    parser.add_argument("--output", type=str, default="models/sentiment_lstm.pth")
